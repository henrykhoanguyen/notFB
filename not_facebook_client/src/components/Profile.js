    ...
    let profileMarkup = !loading ? (authenticated ? (
      ...
      <Paper className={classes.paper}>
        ...
        <div className={classes.buttons}>
          <Button variant='contain' color='secondary' component={Link} to="/login">
            Login
          </Button>
          <Button variant='contain' color='primary' component={Link} to="/signup">
            Signup
          </Button>
        </div>
      </Paper>
